...
(* CORE_GENERATION_INFO = "Top,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Top,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=21,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=3,da_bram_cntlr_cnt=2,da_clkrst_cnt=3,da_xdma_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "Top.hwdef" *) 
module Top
   (DDR3_addr,
    DDR3_ba,
    DDR3_cas_n,
  ...
  LED_BLINKER1_imp_104AQQN LED_BLINKER1
       (.CLK(mig_7series_0_ui_clk),
        ...
        .RESET_L(xdma_0_axi_aresetn));
  Top_axi_interconnect_0_0 axi_interconnect_0
       (.ACLK(util_ds_buf_IBUF_OUT),
