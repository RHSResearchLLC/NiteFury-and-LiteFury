...
proc write_mig_file_design_1_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {        <NewPartName>MT41K512M</NewPartName>}
   ...
   puts $mig_prj_file {            <Bank T2="Address/Ctrl-1" T3="Address/Ctrl-2" name="15" T1="Address/Ctrl-0" />}
   puts $mig_prj_file {            <Bank T3="DQ[8-15]" name="16" T0="DQ[0-7]" />}
   puts $mig_prj_file {        </BankSelection>}
   puts $mig_prj_file {        <System_Clock>}
   puts $mig_prj_file {            <Pin PADName="U20/V20(CC_P/N)" Bank="14" name="sys_clk_p/n" />}
   puts $mig_prj_file {        </System_Clock>}
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net in_1_1 [get_bd_ports in_1] [get_bd_ports out_1]
  ...
  connect_bd_net -net reset_rtl_0_0_1 [get_bd_ports reset_rtl_0_0] [get_bd_pins mig_7series_0/sys_rst]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs mig_7series_0/memmap/memaddr] SEG_mig_7series_0_memaddr
