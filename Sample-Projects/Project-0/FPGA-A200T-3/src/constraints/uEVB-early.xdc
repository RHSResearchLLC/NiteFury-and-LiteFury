# "Late" constraints file
# Note: The board wiring doesn't match the default constraints provided by IP integrator
# So it is necessary to override the IP integrator constrants. To do this, we set the processing order of this file to "Late"
# see https://www.xilinx.com/support/answers/52947.html
