#
# build.tcl: Tcl script for re-creating project 'p0-cle-215p'
#
#*****************************************************************************************
...
set obj [get_projects $new_project_name]
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/$new_project_name.cache/ip" -objects $obj
...
puts "INFO: Project created:${new_project_name}"

# Create block design
# NOTE: Variable 'design_name' gets set at this point.
source $origin_dir/src/bd/project_bd.tcl

# Generate the wrapper
make_wrapper -files [get_files *${design_name}.bd] -top
add_files -norecurse "$origin_dir/${new_project_name}/${new_project_name}.srcs/sources_1/bd/${design_name}/hdl/${design_name}_wrapper.v"
