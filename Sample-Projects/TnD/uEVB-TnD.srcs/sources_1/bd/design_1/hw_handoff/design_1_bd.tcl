...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins util_ds_buf_0/IBUF_OUT]
  connect_bd_net -net xlconstant_1_dout [get_bd_ports LED_A3] [get_bd_ports LED_A4] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports LED_A1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports LED_A2] [get_bd_pins xlslice_1/Dout]
